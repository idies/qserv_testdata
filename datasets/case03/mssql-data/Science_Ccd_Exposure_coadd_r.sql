-- MS SQL DDL ported from MySQL version at C:\workspaces\git\LSST\idies-qserv_testdata\datasets\case03\data\Science_Ccd_Exposure_coadd_r.sql

IF OBJECT_ID('dbo.Science_Ccd_Exposure_coadd_r', 'U') IS NOT NULL
 DROP TABLE dbo.Science_Ccd_Exposure_coadd_r
...
ALTER TABLE [Science_Ccd_Exposure_coadd_r] ADD CONSTRAINT pk_Science_Ccd_Exposure_coadd_r PRIMARY KEY ([scienceCcdExposureId])



 CREATE INDEX ix_Science_Ccd_Exposure_coadd_r_IDX_htmId20 ON [Science_Ccd_Exposure_coadd_r]([htmId20])

 CREATE INDEX ix_Science_Ccd_Exposure_coadd_r_FK_Science_Ccd_Exposure_filterId ON [Science_Ccd_Exposure_coadd_r]([filterId])
